...
export default async function page() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-5">
      <section className="">
        <h2 className="font-secondary font-semibold mb-5">Contactez Nous</h2>
        <p className="mb-5">
        ...
        <form action="" className="flex flex-col gap-4 mb-5">
          ...
          <Input label="Mail" required={true} name="mail" type="email" style="flex-1" />
          <Input label="Téléphone" required={false} name="phone" type="tel" style="flex-1" />
          ...
          <div className="flex-col flex gap-1">
            ...
            <textarea name="message" required={true} className="min-h-32"></textarea>
          </div>
